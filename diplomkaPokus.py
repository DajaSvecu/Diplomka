...
# stehlik 56
t_t1 = t_t #[m] pricna roztec trubek TAB ruzne druhy pro ruzne stupne viz stehlik 56
t_t2 = 0.866*t_t #[m] podelna roztec trubek TAB ruzne druhy pro ruzne stupne viz stehlik 56
# stehlik 125
...
y4 = 1 # 57 zalezi na Re (3 vztahy)
y5 = 1 - x8 + 0.524 * x8**0.32 # 57 0.2 < t_p/D1 < 1; x8 < 0.8
y6 = 1 # 58
y7 = math.exp(0-1.35*S_sS/S_2Z) # 59 zalezi na tesnicich listach
y8 = 1 # 59

w_w = m_w / (S_n * rho_w * (1-math.pi/(4*x6))) # 55 rychlost vody, vztah zalezi na x7
